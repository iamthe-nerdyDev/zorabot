  ...
  return (
    <React.Fragment>
      <nav className="sticky top-0 z-50">
        <Link
          href={'/predictions'}
          className="px-3 py-[5px] gap-2 bg-indigo-300 text-black flex items-center justify-between"
        >
          <div className="flex items-center gap-2">
            <Badge variant="default" className="bg-indigo-600 text-white rounded-full font-mono">
              NEW
            </Badge>
            <p className="text-sm font-medium">You can now bet on your favorite creators</p>
          </div>

          <Button variant="link" className="text-indigo-700 font-medium gap-1">
            <span className="hidden sm:block">Try it out</span>
            <IconArrowRight className="ml-1 animate-wiggle-right" />
          </Button>
        </Link>
